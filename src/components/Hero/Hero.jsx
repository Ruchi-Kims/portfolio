...
function Hero() {
  return (
    ...
    <div className={styles.content}>
        ...
        Mon objectif est de concevoir des interfaces modernes avec une expérience utilisateur agréable qui marie design élégant et fonctionnalité robuste & fluide. <br /><br /> Explorez mon univers numérique...</p>
